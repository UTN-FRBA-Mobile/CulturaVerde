...
import kotlinx.android.synthetic.main.fragment_resumenreservas.view.*
...
class ResumenReservasAdapter(var context: Context, var cartItems: List<CartItem>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(cartItem: CartItem) {
            ...
            var totalPrice = cartItem.quantity.times(cartItem.product.precio!!.toDouble())
            ...
            //itemView.totalreserva.text = totalPrice.toString()
